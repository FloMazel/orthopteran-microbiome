...
Family_plotC = plot_nested_bar(ps_obj = top_nestedC$ps_obj, 
  ...
  theme(strip.text.x =element_text(size=P2+5,angle=90), strip.background=element_blank(),
...
#Family_plot
ggsave(filename =  "Redaction/Submission/ISMEcom_revision/Supp_Data/Supp_Fig_3_Taxonomy_GenusC.pdf",
       plot = Family_plotC, 
...
#Family_plot
ggsave(filename =  "Redaction/Submission/ISMEcom_revision/Supp_Data/Supp_Fig_3_Taxonomy_GenusE.pdf",
       plot = Family_plotE, 
       width = 350, height = 100, device = 'pdf',units="mm")
